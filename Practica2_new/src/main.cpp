...
/** \mainpage RoboComp::PruebaComp
 *
 * \section intro_sec Introduction
 *
 * The PruebaComp component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/PruebaComp --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class PruebaComp : public RoboComp::Application
{
public:
	PruebaComp (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::PruebaComp::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::PruebaComp app(prefix, startup_check_flag);
